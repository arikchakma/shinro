...
test("typegen prepares every generated type artifact in a clean checkout", async () => {
  ...
  try {
    ...
    await expect(readFile(`${root}/.daroyan/rpc.ts`, "utf8")).resolves.toContain(
      'from "../src/routes/users/$id.ts";',
    );
    await expect(readFile(`${root}/.daroyan/rpc.ts`, "utf8")).resolves.toContain(
      'from "../src/routes/users/_middleware.ts";',
    );
    await expect(readFile(`${root}/.daroyan/daroyan.d.ts`, "utf8")).resolves.toContain(
      'from "../src/app.ts";',
    );
    await expect(readFile(`${root}/.daroyan/types/app.d.ts`, "utf8")).resolves.toContain(
      'from "../../src/app.ts";',
    );
