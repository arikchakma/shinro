...
This repository contains Shinro, type-safe file routing and Hono RPC for
user-owned Node.js and Bun servers.

- Package and usage guide: [`packages/shinro/README.md`](./packages/shinro/README.md)
